...
[GitHub](https://github.com/asikarastallion) • [LinkedIn](https://www.linkedin.com/in/mserdarsokmen/) • [Contact](mailto:mserdarsokmen@gmail.com)
...
<!-- IMAGE: METU VTOL overall vehicle -->
<!-- IMAGE: VTOL transition or competition image -->
...
**Relevance**
Demonstrates **system-level decision logic, automation pipelines, and robust software architecture**, complementing my embedded and control-focused UAV work.

**Tech Stack**
- Python, Playwright, FFmpeg, MoviePy, ShazamIO, Edge-TTS

<!-- IMAGE: Automation pipeline diagram or GUI screenshot -->
